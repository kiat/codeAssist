...
TEST_CASES = (
    ...
    StressCase(
        ...
        status="safe",
        reason="Uses a published assignment and measures synchronous grading duration.",
        command_shape="course_first",
        quick_args=(
            "--max_execution_time",
            "1",
    ...
    StressCase(
        ...
        status="safe",
        reason="Uses current /create_enrollment, /leave_course, and /get_user_enrollments endpoints.",
        command_shape="course_first",
        quick_args=(
            "--num_threads",
            "1",
    ...
    StressCase(
        ...
        status="safe",
        reason="Uses current course, assignment, and enrollment cleanup contracts.",
