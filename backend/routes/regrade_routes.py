...
from api import db
from api.models import Assignment, Submission, People, RegradeRequest
from api.schemas import SubmissionSchema, PeopleSchema
# import asyncio
...
def get_student_regrade_requests():
    ...
    for req in regrade_requests:
        ...
        student = db.session.query(People).filter_by(id=submission.student_id).first()
        result.append({
