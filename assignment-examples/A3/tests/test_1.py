...
class TestDiffs(unittest.TestCase):
    ...
    def run_cur_test(self, inpt, outpt):
        proc = subprocess.Popen('python3 -u Cipher.py'.split(),
    ...
    def test_00(self):
        ...
        diff_lines, output = self.run_cur_test(open(f'a3_test_cases/input{cur_num}.txt', 'r'), open(f'a3_test_cases/output{cur_num}.txt', 'r'))
        
        print('Input:')
        print(open(f'a3_test_cases/input{cur_num}.txt', 'r').read())
        print()
        print('Expected Output:')
        print(open(f'a3_test_cases/output{cur_num}.txt', 'r').read())
        print()
        print('Your Output:')
        print('\n'.join(output))
