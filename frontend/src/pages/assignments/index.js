...
//             const submitted = submissionData.completed;
//             const score = submitted ? submissionData.score : null;
//             const submissionId = submissionData.id; // Capture submission ID

//             return {
//               ...assignment,
//               submitted,
//               score,
//               submissionId, // Add submissionId to assignment data
//             };
//           } catch (error) {
//             console.error("Error fetching submission data:", error);
//             return {
...
//               submitted: false,
//               score: null,
//               submissionId: null, // Handle case where no submission is found
//             };
//           }
//         }));
