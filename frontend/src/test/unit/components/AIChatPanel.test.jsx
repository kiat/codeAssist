...
describe("AIChatPanel", () => {
  ...
  it("handles getAssignmentPrompts failure gracefully", async () => {
    getAssignmentPrompts.mockRejectedValue(new Error("Network Error"));
  ...
  it("handles aiFeedbackStatus failure gracefully", async () => {
    aiFeedbackStatus.mockRejectedValue(new Error("500 Server Error"));
